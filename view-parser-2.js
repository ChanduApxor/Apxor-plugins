...
function getMultiplier ()  {
  ...
  if (t) {
    let c = t.getAttribute("content")?.split(",") ?? [];
    let e = 1;
    c.forEach((v, index, arr) => {
      if (c.trimStart().indexOf("initial-scale") === 0) {
        e = parseFloat(v.split("=")[1]);
        console.log("parseFloat", parseFloat(v.split("=")[1]));
      }
    });
    console.log("initial_scale", e);
    return e;
  }
  return 1;
};
